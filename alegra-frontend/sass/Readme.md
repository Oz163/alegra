...
folder are mapped to the application's root namespace, 'Alegra.frontend'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Alegra.frontend' in the same way
as `"Alegra.frontend/sass/src"`.
